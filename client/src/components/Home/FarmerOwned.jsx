...
function FarmerOwned() {
    return (
        <div className='flex flex-col relative -mt-[120%] lg:-mt-[2%] overflow-hidden lg:overflow-visible'>
            <img src={leaf} alt="" className='absolute right-0 md:-top-[13%] lg:-top-[35%] z-[-2] w-[65%]' />
            <div className='bg-white flex justify-between relative z-1 lg:mx-60 py-3 lg:py-5  px-5 lg:px-12 rounded-[2rem] lg:rounded-[3rem] shadow-md lg:mt-5 items-center'>
                {
                    logos.map((elem) => (
            ...
            <div className='mx-3 lg:mx-20 mt-24 lg:mt-40 font-raleway relative'>
                ...
                <div className='flex flex-col lg:flex-row items-center gap-0 lg:gap-10'>
                    <img src={coconut} alt="" className='-ml-10 lg:ml-0'/>
