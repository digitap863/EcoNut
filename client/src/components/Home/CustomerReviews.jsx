...
function CustomerReviews() {
  return (
    <div className='flex flex-col items-center font-raleway relative my-20'>
        <img src={leaf} alt="" className='absolute right-0 top-0 w-[32%] z-[1]' />
        ...
        <Swiper
                    ...
                    >
                        {reviews.map((elem) => (
                            <SwiperSlide className='w-full py-20 pb-20 overs' key={elem.name}>
                                <div key={elem.name} className='shadow-lg hover:-translate-y-3 transition duration-300 ease-in-out w-full flex flex-col justify-center py-16 px-7 rounded-2xl lg:rounded-[3rem] relative bg-white'>
