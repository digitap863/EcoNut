...
function ContactUs() {
  return (
    <div className='flex gap-5 flex-col items-end bg-gradient-to-br overflow-hidden relative font-raleway mb-16 lg:mb-0 lg:my-16 shadow-lg rounded-2xl mx-2 lg:mx-20 lg:pr-12 py-16 from-[#94f1d884] to-white'>
        ...
        <Input placeholder='Type your email' size='lg' className=' mt-3 lg:w-[50%]' color='warning' />
