...
function ContactHeader() {
  ...
  return (
    <div className='h-screen bg-[#006348] font-readex relative overflow-hidden rounded-sideBottom'>
      ...
      <div className='flex ml-28 mr-80 justify-between items-center'>
        <div className='text-white flex flex-col gap-2'>
          <p className='text-2xl font-extralight text-gray-300 mb-3'>Contact Us</p>
          <h1 className='font-semibold text-6xl mb-28'>GET IN TOUCH</h1>
          ...
          <div className='text-4xl flex gap-6 mt-8'>
            <BsFacebook />
            <AiFillInstagram />
            <ImTwitter />
          </div>
        ...
        <div className='relative'>
          <iframe className='w-full flex justify-center lg:w-[180%] mt-20 h-[30rem] rounded-3xl' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15550.787274493794!2d77.53003064193118!3d12.991233155817762!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3da2b2d16bbb%3A0x63ad6fc3882f2d67!2sBasaveshwar%20Nagar%2C%20Bengaluru%2C%20Karnataka%20560079!5e0!3m2!1sen!2sin!4v1698211312368!5m2!1sen!2sin" width="600" height="450" allowfullscreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </div>
  )
