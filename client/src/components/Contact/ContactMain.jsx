    ...
    return (
        ...
        <img src={leafc} alt="" className='absolute md:-top-[10%] lg:-top-[35%]' />
            <div className='flex flex-col px-5 mx-6 md:mx-20 lg:px-0 lg:flex-row justify-center gap-4 lg:gap-10 mt-10 lg:mt-20 relative'>
                <div className='shadow-xl bg-white flex pl-3 lg:pl-6  lg:w-1/3 gap-7 items-center rounded-xl py-4 lg:py-10'>
            ...
            <div className='bg-white items-center flex flex-col gap-10 relative mx-3 lg:mx-20 mt-40 py-10 shadow-xl rounded-xl'>
                ...
                <div className='flex flex-col lg:flex-row gap-10 w-full justify-center items-center'>
                    <input type="text" className='w-[93%] lg:w-[45%] py-2 pl-5 rounded-lg h-12 border-[1px] border-gray-200' placeholder='Your Name' />
                    <input type="text" className='w-[93%] lg:w-[45%] py-2 pl-5 rounded-lg h-12 border-[1px] border-gray-200' placeholder='Your Email' />
                </div>
                <input type="text" className='w-[93%] py-2 pl-5 rounded-lg h-12 border-[1px] border-gray-200' placeholder='Subject' />
                <textarea className='h-48 w-[93%] py-2 pl-5 rounded-lg border-[1px] border-gray-200' placeholder='Your Message' />
