...
function ContactMain() {
    return (
        ...
        <img src={leafc} alt="" className='absolute md:-top-[10%] lg:-top-[35%]' />
            ...
            <div className='bg-white items-center flex flex-col gap-10 relative mx-3 lg:mx-20 mt-20 py-10 shadow-xl rounded-xl'>
                ...
                <div className='flex flex-col lg:flex-row gap-10 w-full justify-center items-center'>
                    <input type="text" className='w-[93%] lg:w-[45%] py-2 pl-5 rounded-lg h-12 border-[1px] border-gray-400' placeholder='Your Name' />
                    <input type="text" className='w-[93%] lg:w-[45%] py-2 pl-5 rounded-lg h-12 border-[1px] border-gray-400' placeholder='Your Email' />
                </div>
