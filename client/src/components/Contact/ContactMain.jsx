...
function ContactMain() {
    return (
        <div className='relative font-readex mx-20 my-16'>
        <img src={leafc} alt="" className='absolute -top-[35%]' />
            <div className='flex flex-col px-5 mx-20 lg:px-0 lg:flex-row justify-center gap-4 lg:gap-10 mt-10 lg:mt-20 relative'>
            ...
            <div className='bg-white items-center flex flex-col gap-10 relative mx-20 mt-20 py-10 shadow-xl rounded-xl'>
                <h1 className='text-[#006348] font-semibold text-5xl'>ASK YOUR QUERIES</h1>
                <div className='flex gap-10 w-full justify-center'>
                    <input type="text" className='w-[45%] py-2 pl-5 rounded-lg h-12 border-[1px] border-gray-400' placeholder='Your Name' />
                    <input type="text" className='w-[45%] py-2 pl-5 rounded-lg h-12 border-[1px] border-gray-400' placeholder='Your Email' />
                </div>
                <input type="text" className='w-[93%] py-2 pl-5 rounded-lg h-12 border-[1px] border-gray-400' placeholder='Subject' />
                <textarea className='w-[93%] py-2 pl-5 rounded-lg h-40 border-[1px] border-gray-400' placeholder='Your Message' />
