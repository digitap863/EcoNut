...
function Navbar() {
  let Links = [
    ...
    { name: "Products", link: "/service" },
    { name: "Community", link: "/showcase" },
  ];
    ...
    <div className='w-full  top-0 left-0 z-30 font-mont'>
      <div className='lg:flex items-center justify-center  py-4 md:px-16 px-7'>
        ...
        <div className='flex justify-center'>
          <ul className={`flex flex-col gap-16  lg:flex-row items-center justify-center lg:justify-start lg:pb-0 pb-12 absolute lg:static lg:z-auto left-0 w-full lg:w-auto text-[#006348] transition-all duration-500 z-[-1] ease-in-out  ${open ? ' top-0 gap-10 text-2xl md:text-4xl h-screen bg-white' : 'top-[-490px]'}`}>
            {
              Links.map((link) => (
                <li key={link.name}>
            ...
            <Button className='bg-transparent border-[#006348] border-[2px] rounded-lg py-1.5 px-7 font-bold'>Contact</Button>
